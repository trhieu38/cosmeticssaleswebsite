...
<head>
            ...
            <div class="menu">
    	        <div class="container">
        	        <div class="nav">
        	            ...
        	            <div class='menu_leve_1'><a href ="cham-soc-da-mat.php">Chăm Sóc Da Mặt</a></div>
                        <div class='menu_leve_1'><a href ="cham-soc-body.php">Chăm Sóc Body</a></div>
    ...
    <!-- Phần dỏ hàng -->
            ...
            <div class="cart_div">
                <a href="shopping-cart.php" class="cart_top">
        ...
        <form method="post">
            ...
            <ul class="bottom_cart">
                <li class="sp">
                    ...
                    <div class="delete_Cart"><a href="delcart.php?id=<?php echo $rows['id_product']; ?>" class="del_sp">Bỏ sản phẩm</a></div>
    ...
    <div class="go_shopping">
    	...
    	<a href="shopping-cart.php" class="goa_shopping">Chuyển tới trang đặt hàng</a></div>
    </div><!--end cart_order-->
	</form>
                    </div><!--End Quick-->
            </div><!--end cart_div-->
