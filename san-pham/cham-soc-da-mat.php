        ...
        <aside class="product_l">
        	<div class="product_boder">
            	<?php 
								...
								$result = mysqli_query($conn,"SELECT * FROM product where type_product=N'chăm sóc da mặt' ORDER BY id_product DESC LIMIT $start, $litmit");
                ...
                <?php
					while ($row = mysqli_fetch_assoc($result))
					{
						...
						echo"
							...
							<div class='price'>".number_format($row['price_product'])." VNĐ</div>
							<div class='price'>".$row['tinh_trang']."</div><!--end price-->
							<div class='ratings'>
