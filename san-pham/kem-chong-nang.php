	    ...
	    <div class="navigation">
    	    <div class="blackRum">
                ...
                <span class="tittleRum">
            	    Chăm Sóc Da Mặt > Kem Chống Nắng
                </span>
        ...
        <aside class="product_l">
        	<div class="product_boder">
            	<?php 
								...
								$result = mysqli_query($conn,"SELECT * FROM product where useful_product=N'kem chống nắng' ORDER BY id_product DESC LIMIT $start, $litmit");
