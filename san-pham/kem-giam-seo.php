        ...
        <aside class="product_l">
        	<div class="product_boder">
            	<?php 
								...
								$result = mysqli_query($conn,"SELECT * FROM product where useful_product=N'kem giảm sẹo' ORDER BY id_product DESC LIMIT $start, $litmit");
